    ...
    <Card class="p-7 sm:p-[34px]">
      ...
      <div v-if="hasContact" class="mb-9 last:mb-0">
        ...
        <div v-if="hasContactLinks" class="grid gap-3.5 sm:grid-cols-2">
          <a v-if="telegramUrl" :href="telegramUrl" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center gap-3 rounded-md border bg-secondary p-4 font-bold text-muted-foreground transition hover:border-hairline-strong hover:text-foreground">
          ...
          <a v-if="whatsappUrl" :href="whatsappUrl" target="_blank" rel="noopener noreferrer" class="flex items-center justify-center gap-3 rounded-md border bg-secondary p-4 font-bold text-muted-foreground transition hover:border-hairline-strong hover:text-foreground">
          ...
          <a :href="`mailto:${supportEmail}`" class="flex items-center justify-center gap-3 rounded-md border bg-secondary p-4 font-bold text-muted-foreground transition hover:border-hairline-strong hover:text-foreground">
            <span>邮件联系：{{ supportEmail }}</span>
          </a>
        </div>
      </div>
    </Card>
...
const {
  supportEmail, telegramUrl, whatsappUrl, heroTitle, heroSubtitle, introductionText, servicesTitle, contactTitle, contactText,
